...
def detect_esp32_port():
    ...
    for p in ports:
        ...
        # Added 'USB Serial' as a common description for ESP32/CP210x on some systems
        ...
        while time.time() - start_time < timeout_seconds:
            if ser.in_waiting > 0:
                ...
                if response:
                    ...
                    # This pattern looks for "DATA:" (optional) followed by optional whitespace,
                    # then captures one or more alphanumeric characters (your NFC ID).
                    # This is more robust for formats like "DATA: 1019............" or "1019"
